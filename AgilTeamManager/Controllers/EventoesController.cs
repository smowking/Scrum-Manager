...
namespace AgilTeamManager.Controllers
{
    public class EventoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,SprintId,DataEvento,Descricao,Fixo,PorcentagemSprint")] Evento evento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,SprintId,DataEvento,Descricao,Fixo,PorcentagemSprint")] Evento evento)
        {
            if (ModelState.IsValid)
            {
